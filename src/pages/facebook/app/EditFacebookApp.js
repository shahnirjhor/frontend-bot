...
function EditFacebookApp() {
    ...
    useEffect(() => {
        callFetch("facebook-apps/"+params.id, "GET", [], setError).then((res) => {
    ...
    const onSubmit = (formData) => {
        setSaving(true);
        callFetch("facebook-apps/"+params.id, "POST", formData, setError).then((res) => {
            setSaving(false);
            if (!res.ok) return;
                                ...
                                <div className="row g-3">
                                    <div className="col-md-6">
                                        ...
                                        <input type="text" className="form-control mb-4" placeholder={t('Type Your App Name Here')}
                                            ...
                                            required
                                        />
                                        <div className="invalid-feedback">{errors.app_name && errors.app_name.message}</div>
                                    </div>
                                    <div className="col-md-6">
                                        ...
                                        <input type="text" className="form-control mb-4" placeholder={t('Type Your Api Id Here')}
                                            ...
                                            required
                                        />
                                        <div className="invalid-feedback">{errors.api_id && errors.api_id.message}</div>
                                    </div>
                                </div>
                                <div className="row g-3">
                                    <div className="col-md-6">
                                        ...
                                        <input type="text" className="form-control mb-4" placeholder={t('Type Your Api Secret Here')}
                                            ...
                                            required
                                        />
                                        <div className="invalid-feedback">{errors.api_secret && errors.api_secret.message}</div>
                                    </div>
                                    <div className="col-md-6">
...
export default EditFacebookApp;